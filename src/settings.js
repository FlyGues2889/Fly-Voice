...
class ThemeManager {
    ...
    initTheme() {
        ...
        let backgroundImageSwitchStatus = false;
        if (backgroundImageSwitch == 'true') {
            backgroundImageSwitchStatus = true;
        } else {
            backgroundImageSwitchStatus = false;
        }

        // 等待dom加载完成
        document.addEventListener('DOMContentLoaded', async () => {
            const lightChooser = document.querySelector('#customLight');
            const customLight = localStorage.getItem('customLight') || '';
            const customLightTip = document.querySelector('#customLightTip')
            if (lightChooser && customLight.startsWith('#')) {
                lightChooser.value = customLight;
                customLightTip.textContent = customLight;
            }
            const backgroundImageSw = document.querySelector('#backgroundImage');
            backgroundImageSw.checked = backgroundImageSwitchStatus;
            if (backgroundImageSwitchStatus) {
